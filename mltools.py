...
def show_history(history):
    ...
    plt.plot(history.epoch, history.history['softmax_loss'], label='train loss+error')
    plt.plot(history.epoch, history.history['val_softmax_loss'], label='val_error')
    plt.legend()
    ...
    plt.plot(history.epoch, history.history['softmax_accuracy'], label='train_acc')
    plt.plot(history.epoch, history.history['val_softmax_accuracy'], label='val_acc')
    plt.legend()
    plt.savefig('figure/total_acc.png')
    plt.close()

    train_acc=history.history['softmax_accuracy']
    val_acc=history.history['val_softmax_accuracy']
    train_loss=history.history['softmax_loss']
    val_loss=history.history['val_softmax_loss']
    epoch=history.epoch
